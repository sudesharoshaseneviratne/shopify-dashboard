...
const searchItems = [
  ...
  { title: "Orders Overview", category: "Orders", href: "/admin/orders", icon: <Package className="w-4 h-4" /> },
  { title: "Draft Orders", category: "Orders", href: "/admin/orders/drafts", icon: <Package className="w-4 h-4" /> },
  { title: "Abandoned Checkouts", category: "Orders", href: "/admin/orders/abandoned", icon: <Package className="w-4 h-4" /> },
  { title: "All Products", category: "Products", href: "/admin/products", icon: <ShoppingBag className="w-4 h-4" /> },
  { title: "Product Collections", category: "Products", href: "/admin/products/collections", icon: <ShoppingBag className="w-4 h-4" /> },
  { title: "Inventory Management", category: "Products", href: "/admin/products/inventory", icon: <ShoppingBag className="w-4 h-4" /> },
  { title: "Purchase Orders", category: "Products", href: "/admin/products/purchase-orders", icon: <ShoppingBag className="w-4 h-4" /> },
  { title: "Stock Transfers", category: "Products", href: "/admin/products/transfers", icon: <ShoppingBag className="w-4 h-4" /> },
  { title: "Gift Cards", category: "Products", href: "/admin/products/gift-cards", icon: <Tag className="w-4 h-4" /> },
  { title: "Customers Directory", category: "Customers", href: "/admin/customers", icon: <Users className="w-4 h-4" /> },
  { title: "Customer Segments", category: "Customers", href: "/admin/customers/segments", icon: <Users className="w-4 h-4" /> },
  { title: "B2B Companies", category: "Customers", href: "/admin/customers/companies", icon: <Users className="w-4 h-4" /> },
  { title: "Discounts & Promotions", category: "Discounts", href: "/admin/discounts", icon: <Tag className="w-4 h-4" /> },
  ...
  return (
    <>
      <div className="h-[48px] w-full bg-[#1a1a1a] text-white flex items-center justify-between px-3 sticky top-0 z-50 select-none">
        ...
        {/* Middle: Admin Search Input Bar OR Unsaved Confirmation Bar (Exact Same Width max-w-[580px]) */}
        {pathname === "/admin/orders/create" || pathname === "/admin/products/new" || pathname === "/admin/products/collections/new" || pathname === "/admin/customers/new" || pathname === "/admin/content/menus/new" ? (
          <div className="flex-1 max-w-[580px] mx-4 relative flex justify-center animate-in fade-in duration-100">
            <div className="w-full bg-[#262626] border border-[#3f3f3f] rounded-lg px-3 py-1 flex items-center justify-between shadow-md">
              <div className="flex items-center gap-2 text-white text-[13px] font-medium">
                <div className="w-4 h-4 rounded-full border border-[#a1a1aa] flex items-center justify-center text-[#a1a1aa] text-[10px] font-bold shrink-0">
                  !
                </div>
                <span className="truncate">
                  {pathname === "/admin/content/menus/new"
                    ? "Unsaved changes"
                    : pathname === "/admin/customers/new"
                    ? "Unsaved customer"
                    : pathname === "/admin/products/collections/new"
                    ? "Unsaved collection"
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  className="px-2.5 py-0.5 text-[12px] font-medium bg-[#3a3a3a] hover:bg-[#4a4a4a] text-white rounded-md transition"
                >
                  Discard
                </button>
                <button
                  ...
                  className="px-2.5 py-0.5 text-[12px] font-medium bg-[#4a4a4a] text-[#8c8c8c] hover:bg-white hover:text-[#1a1a1a] rounded-md transition"
                >
                  Save
                </button>
              </div>
