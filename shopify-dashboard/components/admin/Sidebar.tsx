...
export function Sidebar() {
  ...
  return (
    <div className="w-[240px] bg-[#f1f1f1] h-full overflow-y-auto flex flex-col text-[13px] border-r border-[#e1e3e5] rounded-tl-xl select-none shrink-0 [overscroll-behavior-y:contain] [contain:content] [transform:translateZ(0)]">
